...
📁 Project Structure final_project/ ├── index.js # Main server file ├── booksdb.js # Book data (ISBN-indexed) ├── router/ │ └── auth_users.js # Authenticated user routes └── general.js # Public user routes └── booksdb.js # Book Database
...
POST /register — Register a new user Authenticated Routes (/customer)
POST /login — Log in
